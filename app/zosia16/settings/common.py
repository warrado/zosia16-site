...
# this variable (`sentry_dsn`) isn't set anywhere and raven isn't
# integrated in any place anyway, so if you feel like it it would
# be really cool if you added the support
